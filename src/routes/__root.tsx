  ...
  head: () => ({
    meta: [
      ...
      { title: "BricoMed — Quincaillerie & bricolage en Tunisie" },
      {
        name: "description",
        content:
          "BricoMed, votre quincaillerie de confiance : outillage, électricité, plomberie, peinture, jardinage, visserie et serrurerie. Commandez facilement via WhatsApp.",
      },
      { property: "og:title", content: "BricoMed — Quincaillerie & bricolage" },
      { property: "og:description", content: "Tous vos outils et matériaux, commande simple via WhatsApp." },
